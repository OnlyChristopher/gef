...
@section('clase-active-procedimientos','active')
@section('content')
    <!-- begin breadcrumb -->
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title">Crear Procedimientos</h4>
        </div>
        <div class="panel-body">
            <div class="container">
                ...
                <div class="col-md-8 offset-md-2">
                    <form action="{{route('procedimientos.store')}}" method="post" enctype="multipart/form-data" data-parsley-validate="true" autocomplete="off" >
                        @csrf
                        ...
                        <div class="form-group row m-b-10">
                            <label class="col-md-3 text-md-right col-form-label" for="nombre_proc">Procedimientos</label>
                            <div class="col-md-6">
                                <input type="text" name="nombre_proc" id="nombre_proc" placeholder="Nombre de Procedimiento" class="form-control" data-parsley-required="true" data-parsley-required-message="Por favor Ingresa Nombre de procedimiento" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="file" accept=".pdf"  name="pdf_proc" id="pdf_proc" placeholder="Seleccione Archivo" class="form-control" data-parsley-required="true" data-parsley-required-message="Por favor Seleccione Archivo">
                            </div>
                        </div>

    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <div class="panel-heading-btn">
                <a  class="btn btn-green btn-xs" href="{{ route('cargos.create') }}">Crear nuevo cargo</a>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('cargos.destroy', $cargo->id) }}" method="post">
                                    ...
                                    <button id="btn-cargos-delete" style="display: none;"  type="submit"
                                            class="btn btn-icon btn-circle btn-danger" data-toggle="tooltip" data-container="body" data-id-="{{$cargo->id}}" data-title="Eliminar"><i

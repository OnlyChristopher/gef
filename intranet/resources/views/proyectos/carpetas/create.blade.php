...
@section('content')
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title">Crear Carpetas</h4>
        </div>
        <div class="panel-body">
            <div class="container">
                ...
                <div class="col-md-8 offset-md-2">
                    <form action="{{route('carpetas.store')}}" method="post" enctype="multipart/form-data" data-parsley-validate="true" autocomplete="off" >
                        @csrf
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="nombre" id="nombre" placeholder="Nombre de Carpeta" class="form-control" data-parsley-required="true" data-parsley-required-message="Por favor Ingresa Nombre de Carpeta" >
                            </div>
                        </div>

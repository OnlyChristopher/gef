...
class CarpetasController extends Controller
{
	...
	public function downloadFile($id)
	{
		...
		if(is_null($dl->id_carpetasecundaria)){
			return response()->download("../intranet/storage/app/proyecto/$dl->id_proyecto/$fileOne->nombre/$dl->nombre");
		}else{
			return response()->download("../intranet/storage/app/proyecto/$dl->id_proyecto/$fileOne->nombre/$fileTwo->nombre/$dl->nombre");
		}
	}
}
